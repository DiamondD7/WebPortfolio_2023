        ...
        <div className="description-container__wrapper">
          ...
          {hobbiesClicked && (
            <div
              ...
              style={
                hobbiesClicked ? { animation: "opacityEffect .5s ease-in" } : {}
              }
            >
              <div className="tx">
                <h2 className="description-texts__header">Gaming</h2>
                <p className="description-texts__subheader">
                  I play too often! Lorem ipsum dolor sit amet consectetur
                  adipisicing elit. Ab veniam molestias dolore exercitationem
                  odit ratione neque fuga quibusdam deleniti nihil illo
                  laboriosam repellat, repellendus aspernatur, quaerat delectus
                  laborum fugiat itaque.
                </p>
                <FiMonitor
                  size={"30px"}
                  color="#5e17eb"
                  className="floatfloat"
                />
              </div>
